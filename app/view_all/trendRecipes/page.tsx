// app/View_all/TrendRecipes/page.tsx
...
export default function TrendRecipesPage() {
    ...
    <main className="min-h-screen bg-gray-50 flex flex-col">
      ...
      >
        <div className="max-w-2xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-semibold mb-4">Trending Recipes</h2>
          <p className="text-sm md:text-base text-gray-200 mb-6">
            Discover what's hot in the kitchen right now
          </p>
          ...
          {/* Dietary Restrictions */}
            <div className="flex flex-wrap justify-center gap-2 mt-4">
                <span className="w-full text-center text-white text-sm mb-1">Dietary Restrictions:</span>
                    {allergenKeywords.map((keyword, index) => (
                    <button
                    key={index}
                    onClick={() => handleKeywordClick(keyword)}
      ...
      <div className="flex-grow max-w-[1200px] mx-auto px-4 py-10">
        <h2 className="text-2xl font-semibold mb-6">All Trending Recipes</h2>
